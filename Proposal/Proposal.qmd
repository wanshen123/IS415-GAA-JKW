...
Our project aims to develop a web application leveraging geospatial analytics to optimize recycling bin distribution in Singapore. The application will analyze data on population density, waste generation, and existing bin locations to identify spatial patterns and gaps in coverage. Recommendations will focus on practical actions like bin relocation and density adjustments.
